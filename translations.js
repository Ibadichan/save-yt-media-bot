const translations = {
  en: {
    ...
    donate: {
      ...
      stars_description: "This bot runs purely on donations — no ads, no spam. Every star helps!",
  ...
  ru: {
    ...
    donate: {
      ...
      stars_description: "Бот существует на пожертвования — без рекламы и спама. Каждая звезда важна!",
